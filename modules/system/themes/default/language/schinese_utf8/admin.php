...
define("_OXYGEN_SOURCEFORGE","全球自由软体资源网");
...
define("_OXYGEN_SITEPREF","偏好设定");
define("_OXYGEN_GENERAL","一般设定");
define("_OXYGEN_USERSETTINGS","注册会员设定");
define("_OXYGEN_METAFOOTER","Meta 及页尾");
define("_OXYGEN_CENSOR","敏感词语检查");
define("_OXYGEN_SEARCH","查询选项");
define("_OXYGEN_MAILER","电子邮件设定");
define("_OXYGEN_AUTHENTICATION","认证方式管理");
define("_OXYGEN_MODULESETTINGS","系统基本设定");

//add for styles name
define("_OXYGEN_SILVER",'<font color="SILVER">&nbsp;&nbsp;银&nbsp;&nbsp;</font>');
define("_OXYGEN_DARK",'<font color="DARK">&nbsp;&nbsp;黑&nbsp;&nbsp;</font>');
define("_OXYGEN_ORANGE",'<font color="ORANGE">&nbsp;&nbsp;橙&nbsp;&nbsp;</font>');

//Add 10 des
define("_OXYGEN_XOOPS_LICENSE","XOOPS 授权");
define("_OXYGEN_RSS","RSS 摘要");
define("_OXYGEN_ADMINISTRATION","XOOPS 后台管理");
define("_OXYGEN_UPTOP","到顶端");
